...
'''
    ...
    def get_data(self):
        ...
        dataset  = yf.download(f'{self.symbol}')
        arr_date = dataset.index.to_pydatetime()
        dataset.index  = pd.Series(arr_date,dtype=object)
        raw = pd.DataFrame()
        raw[self.symbol] = dataset['Adj Close']
...
if __name__ == '__main__':
    smabt = SMAVectorBacktester('fcx', 42, 252, '2010-1-1', '2020-12-31')
